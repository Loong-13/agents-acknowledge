...
class QueryIntent(str,Enum):
    """查询意图"""
    FACTOID="factoid" #事务型问题
    ANALYTICAL="analytical" #分析型问题
    COMPARATIVE="comparative" #比较型问题
    PROCEDURAL="procedural" #过程型问题
...
class QAAgent:
    ...
    async def _rewrite_query(self,question:str):
        """查询改写"""
        import json
        messages=[
    ...
    async def _retrieve_vector(self,rewritten:dict)->list[RetrievedContext]:
    ...
    async def _retrieve_graph(self,question:str,rewritten:dict)->list[RetrievedContext]:
